<section class="w-full">
    <x-page-heading>
        <x-slot:title>{{ __('services.create_service') }}</x-slot:title>
        <x-slot:subtitle>
            {{ __('services.create_service_description') }}
        </x-slot:subtitle>
    </x-page-heading>

    <x-form wire:submit="createService" class="space-y-6">
        ...
        <!-- Service Features List Input -->
        <div>
            <label class="block text-sm mb-1">{{ __('services.service_features') }}</label>
        ...
        {{-- File Upload Fields --}}
        <flux:input wire:model.live="image" type="file" label="{{ __('services.image') }}" />
        <flux:input wire:model.live="service_image" type="file" label="{{ __('services.service_image') }}" />
